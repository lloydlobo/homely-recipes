...
// declare a class for footer for the shadowRoot DOM customElement
...
}( /*#__PURE__*/_wrapNativeSuper(HTMLElement)); // Register the new element with the browser.
...
/***/ "./src/functions/extractNutrition.js":
/*!*******************************************!*\
  !*** ./src/functions/extractNutrition.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function extractNutrition() {
  // !!!!!! https://git-secret.io/
  var apiKey = "c0316f7ac3msh83f6c9550985906p1056b6jsn942e8fa4cc71"; // !!!!! encrypt the API
  ...
  var apiHost = "nutrition-by-api-ninjas.p.rapidapi.com"; // let queryUserInput = "chicken 1lb";

  var querySelector = document.getElementById("inputUserQueryNutrition");
  var queryUserInput = querySelector.value;
  ...
  var options = {
    ...
    params: {
      query: queryUserInput // query: "chicken pork beef",
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default().request(options).then(function (response) {
    ...
    nutritionResponse.textContent = JSON.stringify(response.data); // eslint-disable-next-line no-console

    console.table(response.data); // eslint-disable-next-line no-console
...
extractNutrition();
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (extractNutrition);
...
/* joke is api's response data property? */
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body,\nhtml {\n  margin: 0;\n  padding: 0;\n}\n\n/* https://sass-lang.com/documentation/modules/math */\n/* math.div($number1, $number2) //=> number  */\n/* https://sass-lang.com/documentation/at-rules/function */\n/* .02 px difference - inspired by Bootstrap & codercoder */\n/* rem for media query seems to be buggy with safari as of 20220427214236 */\n@font-face {\n  font-family: \"Work Sans\";\n  font-style: normal;\n  font-weight: normal;\n  src: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ") format(\"truetype\");\n}\n@font-face {\n  font-family: \"Parisienne\";\n  font-style: cursive;\n  font-weight: normal;\n  src: url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ") format(\"truetype\");\n}\n/* namespacing utils as u */\nhtml {\n  box-sizing: border-box;\n  font-size: 100%;\n  text-size-adjust: none;\n  -webkit-text-size-adjust: none;\n}\n\n/* 1. Use a more-intuitive box-sizing model. */\n*,\n*::before,\n*::after {\n  box-sizing: inherit;\n}\n\nbody {\n  min-height: 100vh;\n  margin: 0;\n  font-family: \"Work Sans\", Helvetica, Arial, sans-serif;\n  font-size: var(--fs-400, 23px);\n  line-height: 1.5;\n  font-weight: 400;\n  text-rendering: optimizeSpeed;\n  -webkit-font-smoothing: antialiased;\n  color: var(--mdc-theme-on-background);\n  background-color: var(--mdc-theme-success-container);\n  /* overflow-x: hidden; */\n}\n\nbody {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  height: 100vh;\n  overflow-x: hidden;\n  margin: 0;\n  padding: 20px;\n}\n\nhtml:focus-within {\n  scroll-behavior: smooth;\n}\n\n:root {\n  /* color */\n  --mdc-theme-neutral-100: #f5f5f5;\n  --mdc-theme-neutral-200: #eeeeee;\n  --mdc-theme-neutral-300: #e0e0e0;\n  --mdc-theme-neutral-400: #bdbdbd;\n  --mdc-theme-neutral-500: #9e9e9e;\n  --mdc-theme-neutral-600: #757575;\n  --mdc-theme-neutral-700: #616161;\n  --mdc-theme-neutral-800: #424242;\n  --mdc-theme-neutral-900: #212121;\n  --mdc-theme-neutral-1000: #000000;\n  /* material-theme/sys/light/primary */\n  --mdc-theme-primary: #9c413d;\n  --mdc-theme-primary-contrast: #803431;\n  --mdc-theme-on-primary: #ffffff;\n  --mdc-theme-primary-container: #ffdad5;\n  --mdc-theme-on-secondary: #ffffff;\n  --mdc-theme-secondary-container: #ffdad7;\n  --mdc-theme-on-secondary-container: #2c1513;\n  --mdc-theme-tertiary: #725b2e;\n  --mdc-theme-on-tertiary: #ffffff;\n  --mdc-theme-tertiary-container: #ffdea6;\n  --mdc-theme-on-tertiary-container: #271900;\n  --mdc-theme-error: hsl(0, 75%, 42%);\n  --mdc-theme-on-error: hsl(0, 0%, 100%);\n  --mdc-theme-error-container: hsl(8, 100%, 92%);\n  --mdc-theme-on-error-container: hsl(359, 100%, 13%);\n  --mdc-theme-success: #0b4b1d;\n  --mdc-theme-on-success: hsl(0, 0%, 100%);\n  --mdc-theme-success-container: #d6ffe7;\n  --mdc-theme-on-success-container: hsl(359, 100%, 13%);\n  /* color neutrals */\n  --mdc-theme-background: #fcfcfc;\n  --mdc-theme-on-background: #201a19;\n  --mdc-theme-surface: #fcfcfc;\n  --mdc-theme-on-surface: #201a19;\n  /* color surface */\n  --mdc-theme-surface-variant: #f4dddb;\n  --mdc-theme-on-surface-variant: #524342;\n  --mdc-theme-outline: #857371;\n  /* color inverse */\n  --mdc-theme-inverse-primary: #ffb3ab;\n  --mdc-theme-inverse-surface: #362f2e;\n  /* custom */\n  --mdc-theme-on-surface--morph-bg: hsla(9, 12%, 11%, 0.03);\n  /* color - read-only/surface/light */\n  --mdc-theme-surface1: linear-gradient(\n      0deg,\n      rgba(156, 65, 61, 0.05),\n      rgba(156, 65, 61, 0.05)\n    ),\n    #fcfcfc;\n  /* +5% Primary */\n  --mdc-theme-surface2: linear-gradient(\n      0deg,\n      rgba(156, 65, 61, 0.08),\n      rgba(156, 65, 61, 0.08)\n    ),\n    #fcfcfc;\n  /* +8`% Primary */\n  --mdc-theme-surface3: linear-gradient(\n      0deg,\n      rgba(156, 65, 61, 0.11),\n      rgba(156, 65, 61, 0.11)\n    ),\n    #fcfcfc;\n  /* +11% Primary */\n  --mdc-theme-surface4: linear-gradient(\n      0deg,\n      rgba(156, 65, 61, 0.12),\n      rgba(156, 65, 61, 0.12)\n    ),\n    #fcfcfc;\n  /* +12% Primary */\n  --mdc-theme-surface5: linear-gradient(\n      0deg,\n      rgba(156, 65, 61, 0.14),\n      rgba(156, 65, 61, 0.14)\n    ),\n    #fcfcfc;\n  /* +14% Primary */\n  /* shadow */\n  --mdc-theme-shadow: 0 2px 4px -1px rgba(0, 0, 0, 0.2),\n    0 4px 5px 0 rgba(0, 0, 0, 0.14), 0 1px 10px 0 rgba(0, 0, 0, 0.12);\n  --mdc-theme-shadow-on-text: 0 2px 4px rgb(0 0 0 / 12%);\n}\n\n/*! normalize.css v8.0.1 | MIT License | github.com/necolas/normalize.css */\n/* Document\n   ========================================================================== */\n/**\n * 1. Correct the line height in all browsers.\n * 2. Prevent adjustments of font size after orientation changes in iOS.\n */\nhtml {\n  line-height: 1.15;\n  /* 1 */\n  -webkit-text-size-adjust: 100%;\n  /* 2 */\n}\n\n/* Sections\n   ========================================================================== */\n/**\n * Remove the margin in all browsers.\n */\nbody {\n  margin: 0;\n}\n\n/**\n * Render the `main` element consistently in IE.\n */\nmain {\n  display: block;\n}\n\n/**\n * Correct the font size and margin on `h1` elements within `section` and\n * `article` contexts in Chrome, Firefox, and Safari.\n */\nh1 {\n  font-size: 2em;\n  margin: 0.67em 0;\n}\n\n/* Grouping content\n   ========================================================================== */\n/**\n * 1. Add the correct box sizing in Firefox.\n * 2. Show the overflow in Edge and IE.\n */\nhr {\n  box-sizing: content-box;\n  /* 1 */\n  height: 0;\n  /* 1 */\n  overflow: visible;\n  /* 2 */\n}\n\n/**\n * 1. Correct the inheritance and scaling of font size in all browsers.\n * 2. Correct the odd `em` font sizing in all browsers.\n */\npre {\n  font-family: monospace, monospace;\n  /* 1 */\n  font-size: 1em;\n  /* 2 */\n}\n\n/* Text-level semantics\n   ========================================================================== */\n/**\n * Remove the gray background on active links in IE 10.\n */\na {\n  background-color: transparent;\n}\n\n/**\n * 1. Remove the bottom border in Chrome 57-\n * 2. Add the correct text decoration in Chrome, Edge, IE, Opera, and Safari.\n */\nabbr[title] {\n  border-bottom: none;\n  /* 1 */\n  text-decoration: underline;\n  /* 2 */\n  text-decoration: underline dotted;\n  /* 2 */\n}\n\n/**\n * Add the correct font weight in Chrome, Edge, and Safari.\n */\nb,\nstrong {\n  font-weight: bolder;\n}\n\n/**\n * 1. Correct the inheritance and scaling of font size in all browsers.\n * 2. Correct the odd `em` font sizing in all browsers.\n */\ncode,\nkbd,\nsamp {\n  font-family: monospace, monospace;\n  /* 1 */\n  font-size: 1em;\n  /* 2 */\n}\n\n/**\n * Add the correct font size in all browsers.\n */\nsmall {\n  font-size: 80%;\n}\n\n/**\n * Prevent `sub` and `sup` elements from affecting the line height in\n * all browsers.\n */\nsub,\nsup {\n  font-size: 75%;\n  line-height: 0;\n  position: relative;\n  vertical-align: baseline;\n}\n\nsub {\n  bottom: -0.25em;\n}\n\nsup {\n  top: -0.5em;\n}\n\n/* Embedded content\n   ========================================================================== */\n/**\n * Remove the border on images inside links in IE 10.\n */\nimg {\n  border-style: none;\n}\n\n/* Forms\n   ========================================================================== */\n/**\n * 1. Change the font styles in all browsers.\n * 2. Remove the margin in Firefox and Safari.\n */\nbutton,\ninput,\noptgroup,\nselect,\ntextarea {\n  font-family: inherit;\n  /* 1 */\n  font-size: 100%;\n  /* 1 */\n  line-height: 1.15;\n  /* 1 */\n  margin: 0;\n  /* 2 */\n}\n\n/**\n * Show the overflow in IE.\n * 1. Show the overflow in Edge.\n */\nbutton,\ninput {\n  /* 1 */\n  overflow: visible;\n}\n\n/**\n * Remove the inheritance of text transform in Edge, Firefox, and IE.\n * 1. Remove the inheritance of text transform in Firefox.\n */\nbutton,\nselect {\n  /* 1 */\n  text-transform: none;\n}\n\n/**\n * Correct the inability to style clickable types in iOS and Safari.\n */\nbutton,\n[type=button],\n[type=reset],\n[type=submit] {\n  -webkit-appearance: button;\n}\n\n/**\n * Remove the inner border and padding in Firefox.\n */\nbutton::-moz-focus-inner,\n[type=button]::-moz-focus-inner,\n[type=reset]::-moz-focus-inner,\n[type=submit]::-moz-focus-inner {\n  border-style: none;\n  padding: 0;\n}\n\n/**\n * Restore the focus styles unset by the previous rule.\n */\nbutton:-moz-focusring,\n[type=button]:-moz-focusring,\n[type=reset]:-moz-focusring,\n[type=submit]:-moz-focusring {\n  outline: 1px dotted ButtonText;\n}\n\n/**\n * Correct the padding in Firefox.\n */\nfieldset {\n  padding: 0.35em 0.75em 0.625em;\n}\n\n/**\n * 1. Correct the text wrapping in Edge and IE.\n * 2. Correct the color inheritance from `fieldset` elements in IE.\n * 3. Remove the padding so developers are not caught out when they zero out\n *    `fieldset` elements in all browsers.\n */\nlegend {\n  box-sizing: border-box;\n  /* 1 */\n  color: inherit;\n  /* 2 */\n  display: table;\n  /* 1 */\n  max-width: 100%;\n  /* 1 */\n  padding: 0;\n  /* 3 */\n  white-space: normal;\n  /* 1 */\n}\n\n/**\n * Add the correct vertical alignment in Chrome, Firefox, and Opera.\n */\nprogress {\n  vertical-align: baseline;\n}\n\n/**\n * Remove the default vertical scrollbar in IE 10+.\n */\ntextarea {\n  overflow: auto;\n}\n\n/**\n * 1. Add the correct box sizing in IE 10.\n * 2. Remove the padding in IE 10.\n */\n[type=checkbox],\n[type=radio] {\n  box-sizing: border-box;\n  /* 1 */\n  padding: 0;\n  /* 2 */\n}\n\n/**\n * Correct the cursor style of increment and decrement buttons in Chrome.\n */\n[type=number]::-webkit-inner-spin-button,\n[type=number]::-webkit-outer-spin-button {\n  height: auto;\n}\n\n/**\n * 1. Correct the odd appearance in Chrome and Safari.\n * 2. Correct the outline style in Safari.\n */\n[type=search] {\n  -webkit-appearance: textfield;\n  /* 1 */\n  outline-offset: -2px;\n  /* 2 */\n}\n\n/**\n * Remove the inner padding in Chrome and Safari on macOS.\n */\n[type=search]::-webkit-search-decoration {\n  -webkit-appearance: none;\n}\n\n/**\n * 1. Correct the inability to style clickable types in iOS and Safari.\n * 2. Change font properties to `inherit` in Safari.\n */\n::-webkit-file-upload-button {\n  -webkit-appearance: button;\n  /* 1 */\n  font: inherit;\n  /* 2 */\n}\n\n/* Interactive\n   ========================================================================== */\n/*\n * Add the correct display in Edge, IE 10+, and Firefox.\n */\ndetails {\n  display: block;\n}\n\n/*\n * Add the correct display in all browsers.\n */\nsummary {\n  display: list-item;\n}\n\n/* Misc\n   ========================================================================== */\n/**\n * Add the correct display in IE 10+.\n */\ntemplate {\n  display: none;\n}\n\n/**\n * Add the correct display in IE 10.\n */\n[hidden] {\n  display: none;\n}\n\n:root {\n  /* font-family */\n  --ff-cursive: \"Parisienne\", cursive;\n  --ff-sans: \"Work Sans\", Helvetica, Arial, sans-serif;\n}\n\nh1,\nh2,\nh3 {\n  line-height: 1.1;\n  margin-top: 0;\n}\n\nh3 {\n  margin: 0;\n  opacity: 0.5;\n  letter-spacing: 2px;\n}\n\np {\n  min-width: 12ch;\n  margin-top: 0;\n}\n\n.joke {\n  color: darkslategrey;\n  /* works! */\n}\n\na,\na:visited,\na:active {\n  color: var(--mdc-theme-primary);\n  text-decoration: none;\n}\n\n/* namespacing utils as u */\n.grid {\n  display: grid;\n  grid-template-rows: auto 1fr auto;\n  grid-template-columns: auto;\n  gap: 2.5rem;\n  width: min(100% - 2.5rem, 62.5rem);\n  margin-inline: auto;\n}\n.grid__main {\n  display: grid;\n  filter: grayscale(0.5);\n}\n@media (min-width: 56.25em) {\n  .grid__main {\n    filter: grayscale(1);\n  }\n}\n.grid__sidebar {\n  color: hsl(300deg, 100%, 55%);\n}\n\n.container {\n  background-color: #f4f4f4;\n  border-radius: 10px;\n  box-shadow: 0 10px 20px rgba(0, 0, 0, 0.1), 0 6px 6px rgba(0, 0, 0, 0.1);\n  padding: 50px 20px;\n  text-align: center;\n  max-width: 100%;\n  width: 800px;\n}\n\nimg {\n  width: 100px;\n  margin-bottom: 20px;\n}\n\n.joke {\n  font-size: 30px;\n  letter-spacing: 1px;\n  line-height: 40px;\n  margin: 50px auto;\n  max-width: 600px;\n}\n\n.btn {\n  background-color: #2fa8cc;\n  color: #f4f4f4;\n  border: 0;\n  border-radius: 10px;\n  box-shadow: 0 5px 15px rgba(0, 0, 0, 0.1), 0 6px 6px rgba(0, 0, 0, 0.1);\n  padding: 14px 40px;\n  font-size: 16px;\n  cursor: pointer;\n}\n.btn:active {\n  transform: scale(0.98);\n}\n.btn:focus {\n  outline: 0;\n}", "",{"version":3,"sources":["webpack://./src/styles/scss/global.scss","webpack://./src/styles/scss/main.scss","webpack://./src/styles/scss/util/_functions.scss","webpack://./src/styles/scss/util/_breakpoints.scss","webpack://./src/styles/scss/util/_fonts.scss","webpack://./src/styles/scss/base/_boilerplate.scss","webpack://./src/styles/scss/base/_colors.scss","webpack://./src/styles/scss/base/_resets.scss","webpack://./src/styles/scss/base/_typography.scss","webpack://./src/styles/scss/layout/_grid.scss"],"names":[],"mappings":"AAAA;;EAEE,SAAA;EACA,UAAA;ACCF;;ACFA,qDAAA;AACA,8CAAA;AAEA,0DAAA;AC4BA,2DAAA;AACA,2EAAA;ACjCA;EACE,wBAAA;EACA,kBAAA;EACA,mBAAA;EACA,+DAAA;AHWF;AGAA;EACE,yBAAA;EACA,mBAAA;EACA,mBAAA;EACA,+DAAA;AHEF;AItBqB,2BAAA;AAErB;EACE,sBAAA;EACA,eAAA;EAEA,sBAAA;EACA,8BAAA;AJsBF;;AInBA,8CAAA;AACA;;;EAGE,mBAAA;AJsBF;;AInBA;EACE,iBAAA;EACA,SAAA;EAIA,sDAAA;EACA,8BAAA;EACA,gBAAA;EACA,gBAAA;EACA,6BAAA;EACA,mCAAA;EAEA,qCAAA;EACA,oDAAA;EAMA,wBAAA;AJaF;;AIVA;EAGE,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,uBAAA;EACA,aAAA;EACA,kBAAA;EACA,SAAA;EACA,aAAA;AJWF;;AIRA;EACE,uBAAA;AJWF;;AKjEA;EACE,UAAA;EACA,gCAAA;EACA,gCAAA;EACA,gCAAA;EACA,gCAAA;EACA,gCAAA;EACA,gCAAA;EACA,gCAAA;EACA,gCAAA;EACA,gCAAA;EACA,iCAAA;EAEA,qCAAA;EACA,4BAAA;EACA,qCAAA;EACA,+BAAA;EACA,sCAAA;EACA,iCAAA;EACA,wCAAA;EACA,2CAAA;EACA,6BAAA;EACA,gCAAA;EACA,uCAAA;EACA,0CAAA;EACA,mCAAA;EACA,sCAAA;EACA,8CAAA;EACA,mDAAA;EACA,4BAAA;EACA,wCAAA;EACA,sCAAA;EACA,qDAAA;EAEA,mBAAA;EACA,+BAAA;EACA,kCAAA;EACA,4BAAA;EACA,+BAAA;EAEA,kBAAA;EACA,oCAAA;EACA,uCAAA;EACA,4BAAA;EAEA,kBAAA;EACA,oCAAA;EACA,oCAAA;EAEA,WAAA;EACA,yDAAA;EAEA,oCAAA;EACA;;;;;WAAA;EAKW,gBAAA;EACX;;;;;WAAA;EAKW,iBAAA;EACX;;;;;WAAA;EAKW,iBAAA;EACX;;;;;WAAA;EAKW,iBAAA;EACX;;;;;WAAA;EAKW,iBAAA;EAEX,WAAA;EACA;qEAAA;EAEA,sDAAA;ALkEF;;AMzJA,2EAAA;AAEA;+EAAA;AAGA;;;EAAA;AAKA;EACE,iBAAA;EAAmB,MAAA;EACnB,8BAAA;EAAgC,MAAA;AN2JlC;;AMxJA;+EAAA;AAGA;;EAAA;AAIA;EACE,SAAA;ANyJF;;AMtJA;;EAAA;AAIA;EACE,cAAA;ANwJF;;AMrJA;;;EAAA;AAKA;EACE,cAAA;EACA,gBAAA;ANuJF;;AMpJA;+EAAA;AAGA;;;EAAA;AAKA;EACE,uBAAA;EAAyB,MAAA;EACzB,SAAA;EAAW,MAAA;EACX,iBAAA;EAAmB,MAAA;ANwJrB;;AMrJA;;;EAAA;AAKA;EACE,iCAAA;EAAmC,MAAA;EACnC,cAAA;EAAgB,MAAA;ANyJlB;;AMtJA;+EAAA;AAGA;;EAAA;AAIA;EACE,6BAAA;ANuJF;;AMpJA;;;EAAA;AAKA;EACE,mBAAA;EAAqB,MAAA;EACrB,0BAAA;EAA4B,MAAA;EAC5B,iCAAA;EAAmC,MAAA;ANyJrC;;AMtJA;;EAAA;AAIA;;EAEE,mBAAA;ANwJF;;AMrJA;;;EAAA;AAKA;;;EAGE,iCAAA;EAAmC,MAAA;EACnC,cAAA;EAAgB,MAAA;ANyJlB;;AMtJA;;EAAA;AAIA;EACE,cAAA;ANwJF;;AMrJA;;;EAAA;AAKA;;EAEE,cAAA;EACA,cAAA;EACA,kBAAA;EACA,wBAAA;ANuJF;;AMpJA;EACE,eAAA;ANuJF;;AMpJA;EACE,WAAA;ANuJF;;AMpJA;+EAAA;AAGA;;EAAA;AAIA;EACE,kBAAA;ANqJF;;AMlJA;+EAAA;AAGA;;;EAAA;AAKA;;;;;EAKE,oBAAA;EAAsB,MAAA;EACtB,eAAA;EAAiB,MAAA;EACjB,iBAAA;EAAmB,MAAA;EACnB,SAAA;EAAW,MAAA;ANuJb;;AMpJA;;;EAAA;AAKA;;EACQ,MAAA;EACN,iBAAA;ANuJF;;AMpJA;;;EAAA;AAKA;;EACS,MAAA;EACP,oBAAA;ANuJF;;AMpJA;;EAAA;AAIA;;;;EAIE,0BAAA;ANsJF;;AMnJA;;EAAA;AAIA;;;;EAIE,kBAAA;EACA,UAAA;ANqJF;;AMlJA;;EAAA;AAIA;;;;EAIE,8BAAA;ANoJF;;AMjJA;;EAAA;AAIA;EACE,8BAAA;ANmJF;;AMhJA;;;;;EAAA;AAOA;EACE,sBAAA;EAAwB,MAAA;EACxB,cAAA;EAAgB,MAAA;EAChB,cAAA;EAAgB,MAAA;EAChB,eAAA;EAAiB,MAAA;EACjB,UAAA;EAAY,MAAA;EACZ,mBAAA;EAAqB,MAAA;ANwJvB;;AMrJA;;EAAA;AAIA;EACE,wBAAA;ANuJF;;AMpJA;;EAAA;AAIA;EACE,cAAA;ANsJF;;AMnJA;;;EAAA;AAKA;;EAEE,sBAAA;EAAwB,MAAA;EACxB,UAAA;EAAY,MAAA;ANuJd;;AMpJA;;EAAA;AAIA;;EAEE,YAAA;ANsJF;;AMnJA;;;EAAA;AAKA;EACE,6BAAA;EAA+B,MAAA;EAC/B,oBAAA;EAAsB,MAAA;ANuJxB;;AMpJA;;EAAA;AAIA;EACE,wBAAA;ANsJF;;AMnJA;;;EAAA;AAKA;EACE,0BAAA;EAA4B,MAAA;EAC5B,aAAA;EAAe,MAAA;ANuJjB;;AMpJA;+EAAA;AAGA;;EAAA;AAIA;EACE,cAAA;ANqJF;;AMlJA;;EAAA;AAIA;EACE,kBAAA;ANoJF;;AMjJA;+EAAA;AAGA;;EAAA;AAIA;EACE,aAAA;ANkJF;;AM/IA;;EAAA;AAIA;EACE,aAAA;ANiJF;;AO5eA;EACE,gBAAA;EACA,mCAAA;EACA,oDAAA;AP+eF;;AO5eA;;;EAGE,gBAAA;EACA,aAAA;AP+eF;;AO5eA;EACE,SAAA;EACA,YAAA;EACA,mBAAA;AP+eF;;AO5eA;EACE,eAAA;EACA,aAAA;AP+eF;;AO5eA;EACE,oBAAA;EAAsB,WAAA;APgfxB;;AO7eA;;;EAGE,+BAAA;EACA,qBAAA;APgfF;;AQhhBqB,2BAAA;AAErB;EACE,aAAA;EACA,iCAAA;EACA,2BAAA;EACA,WAAA;EAEA,kCAAA;EACA,mBAAA;ARihBF;AQ/gBE;EACE,aAAA;EACA,sBAAA;ARihBJ;AE5gBI;EMPF;IAKI,oBAAA;ERkhBJ;AACF;AQ/gBE;EACE,6BAAA;ARihBJ;;AArhBA;EACE,yBAJgB;EAKhB,mBAAA;EACA,wEALW;EAMX,kBAAA;EACA,kBAAA;EACA,eAAA;EACA,YAAA;AAwhBF;;AArhBA;EACE,YAAA;EACA,mBAAA;AAwhBF;;AArhBA;EACE,eAAA;EACA,mBAAA;EACA,iBAAA;EACA,iBAAA;EACA,gBAAA;AAwhBF;;AArhBA;EACE,yBA5Bc;EA6Bd,cA5BgB;EA6BhB,SAAA;EACA,mBAAA;EACA,uEAAA;EACA,kBAAA;EACA,eAAA;EACA,eAAA;AAwhBF;AAthBE;EACE,sBAAA;AAwhBJ;AArhBE;EACE,UAAA;AAuhBJ","sourcesContent":["body,\nhtml {\n  margin: 0;\n  padding: 0;\n}\n","@forward \"global\";\n\n@forward \"base\";\n@forward \"components\";\n@forward \"layout\";\n@forward \"util\";\n@forward \"vendors\";\n\n// https://google.github.io/styleguide/htmlcssguide.html#CSS_Style_Rules\n// -----------------------------\n//  * Bring that right into index.js\n// https://github.com/bradtraversy/webpack-starter/blob/main/src/styles/main.scss\n// -----------------------------\n$primary-color: #2fa8cc;\n$secondary-color: #f4f4f4;\n$box-shadow: 0 10px 20px rgba(0, 0, 0, 0.1), 0 6px 6px rgba(0, 0, 0, 0.1);\n\n.container {\n  background-color: $secondary-color;\n  border-radius: 10px;\n  box-shadow: $box-shadow;\n  padding: 50px 20px;\n  text-align: center;\n  max-width: 100%;\n  width: 800px;\n}\n\nimg {\n  width: 100px;\n  margin-bottom: 20px;\n}\n\n.joke {\n  font-size: 30px;\n  letter-spacing: 1px;\n  line-height: 40px;\n  margin: 50px auto;\n  max-width: 600px;\n}\n\n.btn {\n  background-color: $primary-color;\n  color: $secondary-color;\n  border: 0;\n  border-radius: 10px;\n  box-shadow: 0 5px 15px rgba(0, 0, 0, 0.1), 0 6px 6px rgba(0, 0, 0, 0.1);\n  padding: 14px 40px;\n  font-size: 16px;\n  cursor: pointer;\n\n  &:active {\n    transform: scale(0.98);\n  }\n\n  &:focus {\n    outline: 0;\n  }\n}\n","@use 'sass:math';\n\n/* https://sass-lang.com/documentation/modules/math */\n/* math.div($number1, $number2) //=> number  */\n\n/* https://sass-lang.com/documentation/at-rules/function */\n// divide $pixel by 16 to return rem unit\n@function rem($pixel) {\n  // throw an error when parameter includes 'px' string or any unit\n  @if math.is-unitless($pixel)  {\n    @return math.div($pixel, 16) + rem;\n  } @else {\n    @error \"Property #{$pixel} must be unitless when using rem function. Only numbers please.\";\n    // @return unit($pixel);\n  }\n}\n\n// divide $pixel by 16 to return em unit\n@function em($pixel) {\n  // throw an error when parameter includes 'px' string or any unit\n  @if math.is-unitless($pixel)  {\n    @return math.div($pixel, 16) + em;\n  } @else {\n    @error \"Property #{$pixel} must be unitless when using em function. Only numbers please.\";\n    // @return unit($pixel);\n  }\n}\n\n\n","@use 'functions' as f;\n\n// 700px, 900px, 1440px\n$breakpoints-up: (\n    'medium': f.em(700), /* 43.75em */\n    'large': f.em(900), /* 56.25em */\n    'xlarge': f.em(1440), /* 90em */\n);\n\n// 699.98px, 899.98px, 1439.98px\n$breakpoints-down: (\n    'small': f.em(699.98), /* 43.7485em */\n    'medium': f.em(899.98), /* 56.24875em */\n    'large': f.em(1439.98), /* 89.99875em */\n);\n\n// mixins defacto\n@mixin breakpoint($size) {\n    @media (min-width: map-get($breakpoints-up, $size)) {\n        @content;\n    }\n}\n\n// special cases - styling for mobile scenarios\n@mixin breakpoint-down($size) {\n    @media (max-width: map-get($breakpoints-down, $size)) {\n        @content;\n    }\n}\n\n// ! Order of breakpoints in cascade matters !\n// --------------------------------FIN------------------------------------------\n\n/* .02 px difference - inspired by Bootstrap & codercoder */\n/* rem for media query seems to be buggy with safari as of 20220427214236 */\n","// sass variables - not relevant as css custom variables can be modified with JavaScript\n@font-face {\n  font-family: \"Work Sans\";\n  font-style: normal;\n  font-weight: normal;\n  src: url(\"../fonts/Work_Sans/WorkSans-VariableFont_wght.ttf\") format(\"truetype\");\n}\n\n\n// @font-face {\n//   font-family: \"Work Sans\";\n//   font-style: italic;\n//   font-weight: normal;\n//   src: url(\"../fonts/Work_Sans/WorkSans-Italic-VariableFont_wght.ttf\") format(\"truetype\");\n// }\n\n@font-face {\n  font-family: \"Parisienne\";\n  font-style: cursive;\n  font-weight: normal;\n  src: url(\"../fonts/Parisienne/Parisienne-Regular.ttf\") format(\"truetype\");\n}\n\n$font-sans: \"Work Sans\", Helvetica, Arial, sans-serif;\n$font-cursive: \"Parisienne\", cursive;\n\n// -----------------------------------------------------------------------------\n\n// :root {\n//   /* font-family */\n//   --ff-cursive: \"Parisienne\", cursive;\n//   --ff-sans: \"Work Sans\", Helvetica, Arial, sans-serif;\n// }\n","@use \"../util\" as u; /* namespacing utils as u */\n\nhtml {\n  box-sizing: border-box;\n  font-size: 100%;\n\n  text-size-adjust: none;\n  -webkit-text-size-adjust: none;\n}\n\n/* 1. Use a more-intuitive box-sizing model. */\n*,\n*::before,\n*::after {\n  box-sizing: inherit;\n}\n\nbody {\n  min-height: 100vh;\n  margin: 0;\n  // padding-top: unset; /* enable this */\n\n  // font-family: var(--ff-sans);\n  font-family: u.$font-sans;\n  font-size: var(--fs-400, 23px);\n  line-height: 1.5;\n  font-weight: 400;\n  text-rendering: optimizeSpeed;\n  -webkit-font-smoothing: antialiased;\n\n  color: var(--mdc-theme-on-background);\n  background-color: var(--mdc-theme-success-container);\n\n  // display: grid;\n  // grid-template-rows: auto 1fr auto;\n\n  // background-color: var(--mdc-theme-background, #fcfcfc); /* enable later */\n  /* overflow-x: hidden; */\n}\n\nbody {\n  // background-color: $primary-color;\n  // font-family: \"Roboto\", sans-serif;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  height: 100vh;\n  overflow-x: hidden;\n  margin: 0;\n  padding: 20px;\n}\n\nhtml:focus-within {\n  scroll-behavior: smooth;\n}\n",":root {\n  /* color */\n  --mdc-theme-neutral-100: #f5f5f5;\n  --mdc-theme-neutral-200: #eeeeee;\n  --mdc-theme-neutral-300: #e0e0e0;\n  --mdc-theme-neutral-400: #bdbdbd;\n  --mdc-theme-neutral-500: #9e9e9e;\n  --mdc-theme-neutral-600: #757575;\n  --mdc-theme-neutral-700: #616161;\n  --mdc-theme-neutral-800: #424242;\n  --mdc-theme-neutral-900: #212121;\n  --mdc-theme-neutral-1000: #000000;\n\n  /* material-theme/sys/light/primary */\n  --mdc-theme-primary: #9c413d;\n  --mdc-theme-primary-contrast: #803431;\n  --mdc-theme-on-primary: #ffffff;\n  --mdc-theme-primary-container: #ffdad5;\n  --mdc-theme-on-secondary: #ffffff;\n  --mdc-theme-secondary-container: #ffdad7;\n  --mdc-theme-on-secondary-container: #2c1513;\n  --mdc-theme-tertiary: #725b2e;\n  --mdc-theme-on-tertiary: #ffffff;\n  --mdc-theme-tertiary-container: #ffdea6;\n  --mdc-theme-on-tertiary-container: #271900;\n  --mdc-theme-error: hsl(0, 75%, 42%);\n  --mdc-theme-on-error: hsl(0, 0%, 100%);\n  --mdc-theme-error-container: hsl(8, 100%, 92%);\n  --mdc-theme-on-error-container: hsl(359, 100%, 13%);\n  --mdc-theme-success: #0b4b1d;\n  --mdc-theme-on-success: hsl(0, 0%, 100%);\n  --mdc-theme-success-container: #d6ffe7;\n  --mdc-theme-on-success-container: hsl(359, 100%, 13%);\n\n  /* color neutrals */\n  --mdc-theme-background: #fcfcfc;\n  --mdc-theme-on-background: #201a19;\n  --mdc-theme-surface: #fcfcfc;\n  --mdc-theme-on-surface: #201a19;\n\n  /* color surface */\n  --mdc-theme-surface-variant: #f4dddb;\n  --mdc-theme-on-surface-variant: #524342;\n  --mdc-theme-outline: #857371;\n\n  /* color inverse */\n  --mdc-theme-inverse-primary: #ffb3ab;\n  --mdc-theme-inverse-surface: #362f2e;\n\n  /* custom */\n  --mdc-theme-on-surface--morph-bg: hsla(9, 12%, 11%, 0.03);\n\n  /* color - read-only/surface/light */\n  --mdc-theme-surface1: linear-gradient(\n      0deg,\n      rgba(156, 65, 61, 0.05),\n      rgba(156, 65, 61, 0.05)\n    ),\n    #fcfcfc; /* +5% Primary */\n  --mdc-theme-surface2: linear-gradient(\n      0deg,\n      rgba(156, 65, 61, 0.08),\n      rgba(156, 65, 61, 0.08)\n    ),\n    #fcfcfc; /* +8`% Primary */\n  --mdc-theme-surface3: linear-gradient(\n      0deg,\n      rgba(156, 65, 61, 0.11),\n      rgba(156, 65, 61, 0.11)\n    ),\n    #fcfcfc; /* +11% Primary */\n  --mdc-theme-surface4: linear-gradient(\n      0deg,\n      rgba(156, 65, 61, 0.12),\n      rgba(156, 65, 61, 0.12)\n    ),\n    #fcfcfc; /* +12% Primary */\n  --mdc-theme-surface5: linear-gradient(\n      0deg,\n      rgba(156, 65, 61, 0.14),\n      rgba(156, 65, 61, 0.14)\n    ),\n    #fcfcfc; /* +14% Primary */\n\n  /* shadow */\n  --mdc-theme-shadow: 0 2px 4px -1px rgba(0, 0, 0, 0.2),\n    0 4px 5px 0 rgba(0, 0, 0, 0.14), 0 1px 10px 0 rgba(0, 0, 0, 0.12);\n  --mdc-theme-shadow-on-text: 0 2px 4px rgb(0 0 0 / 12%);\n}\n","/*! normalize.css v8.0.1 | MIT License | github.com/necolas/normalize.css */\n\n/* Document\n   ========================================================================== */\n\n/**\n * 1. Correct the line height in all browsers.\n * 2. Prevent adjustments of font size after orientation changes in iOS.\n */\n\nhtml {\n  line-height: 1.15; /* 1 */\n  -webkit-text-size-adjust: 100%; /* 2 */\n}\n\n/* Sections\n   ========================================================================== */\n\n/**\n * Remove the margin in all browsers.\n */\n\nbody {\n  margin: 0;\n}\n\n/**\n * Render the `main` element consistently in IE.\n */\n\nmain {\n  display: block;\n}\n\n/**\n * Correct the font size and margin on `h1` elements within `section` and\n * `article` contexts in Chrome, Firefox, and Safari.\n */\n\nh1 {\n  font-size: 2em;\n  margin: 0.67em 0;\n}\n\n/* Grouping content\n   ========================================================================== */\n\n/**\n * 1. Add the correct box sizing in Firefox.\n * 2. Show the overflow in Edge and IE.\n */\n\nhr {\n  box-sizing: content-box; /* 1 */\n  height: 0; /* 1 */\n  overflow: visible; /* 2 */\n}\n\n/**\n * 1. Correct the inheritance and scaling of font size in all browsers.\n * 2. Correct the odd `em` font sizing in all browsers.\n */\n\npre {\n  font-family: monospace, monospace; /* 1 */\n  font-size: 1em; /* 2 */\n}\n\n/* Text-level semantics\n   ========================================================================== */\n\n/**\n * Remove the gray background on active links in IE 10.\n */\n\na {\n  background-color: transparent;\n}\n\n/**\n * 1. Remove the bottom border in Chrome 57-\n * 2. Add the correct text decoration in Chrome, Edge, IE, Opera, and Safari.\n */\n\nabbr[title] {\n  border-bottom: none; /* 1 */\n  text-decoration: underline; /* 2 */\n  text-decoration: underline dotted; /* 2 */\n}\n\n/**\n * Add the correct font weight in Chrome, Edge, and Safari.\n */\n\nb,\nstrong {\n  font-weight: bolder;\n}\n\n/**\n * 1. Correct the inheritance and scaling of font size in all browsers.\n * 2. Correct the odd `em` font sizing in all browsers.\n */\n\ncode,\nkbd,\nsamp {\n  font-family: monospace, monospace; /* 1 */\n  font-size: 1em; /* 2 */\n}\n\n/**\n * Add the correct font size in all browsers.\n */\n\nsmall {\n  font-size: 80%;\n}\n\n/**\n * Prevent `sub` and `sup` elements from affecting the line height in\n * all browsers.\n */\n\nsub,\nsup {\n  font-size: 75%;\n  line-height: 0;\n  position: relative;\n  vertical-align: baseline;\n}\n\nsub {\n  bottom: -0.25em;\n}\n\nsup {\n  top: -0.5em;\n}\n\n/* Embedded content\n   ========================================================================== */\n\n/**\n * Remove the border on images inside links in IE 10.\n */\n\nimg {\n  border-style: none;\n}\n\n/* Forms\n   ========================================================================== */\n\n/**\n * 1. Change the font styles in all browsers.\n * 2. Remove the margin in Firefox and Safari.\n */\n\nbutton,\ninput,\noptgroup,\nselect,\ntextarea {\n  font-family: inherit; /* 1 */\n  font-size: 100%; /* 1 */\n  line-height: 1.15; /* 1 */\n  margin: 0; /* 2 */\n}\n\n/**\n * Show the overflow in IE.\n * 1. Show the overflow in Edge.\n */\n\nbutton,\ninput { /* 1 */\n  overflow: visible;\n}\n\n/**\n * Remove the inheritance of text transform in Edge, Firefox, and IE.\n * 1. Remove the inheritance of text transform in Firefox.\n */\n\nbutton,\nselect { /* 1 */\n  text-transform: none;\n}\n\n/**\n * Correct the inability to style clickable types in iOS and Safari.\n */\n\nbutton,\n[type=\"button\"],\n[type=\"reset\"],\n[type=\"submit\"] {\n  -webkit-appearance: button;\n}\n\n/**\n * Remove the inner border and padding in Firefox.\n */\n\nbutton::-moz-focus-inner,\n[type=\"button\"]::-moz-focus-inner,\n[type=\"reset\"]::-moz-focus-inner,\n[type=\"submit\"]::-moz-focus-inner {\n  border-style: none;\n  padding: 0;\n}\n\n/**\n * Restore the focus styles unset by the previous rule.\n */\n\nbutton:-moz-focusring,\n[type=\"button\"]:-moz-focusring,\n[type=\"reset\"]:-moz-focusring,\n[type=\"submit\"]:-moz-focusring {\n  outline: 1px dotted ButtonText;\n}\n\n/**\n * Correct the padding in Firefox.\n */\n\nfieldset {\n  padding: 0.35em 0.75em 0.625em;\n}\n\n/**\n * 1. Correct the text wrapping in Edge and IE.\n * 2. Correct the color inheritance from `fieldset` elements in IE.\n * 3. Remove the padding so developers are not caught out when they zero out\n *    `fieldset` elements in all browsers.\n */\n\nlegend {\n  box-sizing: border-box; /* 1 */\n  color: inherit; /* 2 */\n  display: table; /* 1 */\n  max-width: 100%; /* 1 */\n  padding: 0; /* 3 */\n  white-space: normal; /* 1 */\n}\n\n/**\n * Add the correct vertical alignment in Chrome, Firefox, and Opera.\n */\n\nprogress {\n  vertical-align: baseline;\n}\n\n/**\n * Remove the default vertical scrollbar in IE 10+.\n */\n\ntextarea {\n  overflow: auto;\n}\n\n/**\n * 1. Add the correct box sizing in IE 10.\n * 2. Remove the padding in IE 10.\n */\n\n[type=\"checkbox\"],\n[type=\"radio\"] {\n  box-sizing: border-box; /* 1 */\n  padding: 0; /* 2 */\n}\n\n/**\n * Correct the cursor style of increment and decrement buttons in Chrome.\n */\n\n[type=\"number\"]::-webkit-inner-spin-button,\n[type=\"number\"]::-webkit-outer-spin-button {\n  height: auto;\n}\n\n/**\n * 1. Correct the odd appearance in Chrome and Safari.\n * 2. Correct the outline style in Safari.\n */\n\n[type=\"search\"] {\n  -webkit-appearance: textfield; /* 1 */\n  outline-offset: -2px; /* 2 */\n}\n\n/**\n * Remove the inner padding in Chrome and Safari on macOS.\n */\n\n[type=\"search\"]::-webkit-search-decoration {\n  -webkit-appearance: none;\n}\n\n/**\n * 1. Correct the inability to style clickable types in iOS and Safari.\n * 2. Change font properties to `inherit` in Safari.\n */\n\n::-webkit-file-upload-button {\n  -webkit-appearance: button; /* 1 */\n  font: inherit; /* 2 */\n}\n\n/* Interactive\n   ========================================================================== */\n\n/*\n * Add the correct display in Edge, IE 10+, and Firefox.\n */\n\ndetails {\n  display: block;\n}\n\n/*\n * Add the correct display in all browsers.\n */\n\nsummary {\n  display: list-item;\n}\n\n/* Misc\n   ========================================================================== */\n\n/**\n * Add the correct display in IE 10+.\n */\n\ntemplate {\n  display: none;\n}\n\n/**\n * Add the correct display in IE 10.\n */\n\n[hidden] {\n  display: none;\n}\n",":root {\n  /* font-family */\n  --ff-cursive: \"Parisienne\", cursive;\n  --ff-sans: \"Work Sans\", Helvetica, Arial, sans-serif;\n}\n\nh1,\nh2,\nh3 {\n  line-height: 1.1;\n  margin-top: 0;\n}\n\nh3 {\n  margin: 0;\n  opacity: 0.5;\n  letter-spacing: 2px;\n}\n\np {\n  min-width: 12ch;\n  margin-top: 0;\n}\n\n.joke {\n  color: darkslategrey; /* works! */\n}\n\na,\na:visited,\na:active {\n  color: var(--mdc-theme-primary);\n  text-decoration: none;\n}\n","@use \"../util\" as u; /* namespacing utils as u */\n\n.grid {\n  display: grid;\n  grid-template-rows: auto 1fr auto;\n  grid-template-columns: auto;\n  gap: u.rem(40);\n  // backdrop-filter: blur(u.rem(100));\n  width: min(100% - u.rem(40), u.rem(1000));\n  margin-inline: auto;\n\n  &__main {\n    display: grid;\n    filter: grayscale(0.5);\n\n    @include u.breakpoint(large) {\n      filter: grayscale(1);\n    }\n  }\n\n  &__sidebar {\n    color: hsl(300, 100%, 55%);\n  }\n}\n"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _components_partials_footer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/partials/footer */ "./src/components/partials/footer.js");
/* harmony import */ var _components_partials_navigation__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/partials/navigation */ "./src/components/partials/navigation.js");
/* harmony import */ var _functions_extractNutrition__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./functions/extractNutrition */ "./src/functions/extractNutrition.js");
/* harmony import */ var _functions_generateJokes__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./functions/generateJokes */ "./src/functions/generateJokes.js");
...
var btnNutrition = document.getElementById("btnNutrition");
laughingImg.src = _assets_laughing_svg__WEBPACK_IMPORTED_MODULE_1__; // extract nutrition
...
btnNutrition.addEventListener("click", function () {
  (0,_functions_extractNutrition__WEBPACK_IMPORTED_MODULE_4__["default"])();
}); // extractNutrition();

var btnGenerateJokes = document.getElementById("btnJoke"); // // generate jokes card

btnGenerateJokes.addEventListener("click", function () {
  (0,_functions_generateJokes__WEBPACK_IMPORTED_MODULE_5__["default"])();
});
(0,_functions_generateJokes__WEBPACK_IMPORTED_MODULE_5__["default"])(); // Call imported function `generateJokes` once
// **** shadowDOM Custom Elements ****

window.customElements.define("navigation-component", _components_partials_navigation__WEBPACK_IMPORTED_MODULE_3__["default"]);
window.customElements.define("footer-component", _components_partials_footer__WEBPACK_IMPORTED_MODULE_2__["default"]);
})();

/******/ })()
;
//# sourceMappingURL=bundle.afbd61bf51ea62dc0c6c.js.map