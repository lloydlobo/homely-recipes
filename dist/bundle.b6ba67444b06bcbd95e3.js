...
var axios = __webpack_require__(/*! axios */ "./node_modules/axios/index.js"); // Query text to extract nutrition information (e.g. bacon and 3 eggs).


var inputUserQuery = document.querySelector("#inputUserQueryNutrition");
var nutritionResponse = document.querySelector("#nutritionResponse");
console.dir(nutritionResponse);
var inputUserQueryValue;
inputUserQuery.addEventListener("change", function () {
  inputUserQueryValue = inputUserQuery.value;
  console.log(inputUserQueryValue);
  console.log(_typeof(inputUserQueryValue));
...
function extractNutrition() {
  var options = {
    ...
    params: {
      query: "".concat(inputUserQueryValue)
    },
    headers: {
...
/* harmony import */ var _functions_generateJokes__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./functions/generateJokes */ "./src/functions/generateJokes.js");
...
/* harmony import */ var _styles_scss_main_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./styles/scss/main.scss */ "./src/styles/scss/main.scss");
...
console.log("Hi"); // extract nutrition

var btnNutrition = document.querySelector("#btnNutrition");
btnNutrition.addEventListener("click", _functions_extractNutrition__WEBPACK_IMPORTED_MODULE_4__["default"]);
(0,_functions_extractNutrition__WEBPACK_IMPORTED_MODULE_4__["default"])(); // Call imported function `extractNutrition` once
...
btnGenerateJokes.addEventListener("click", _functions_generateJokes__WEBPACK_IMPORTED_MODULE_3__["default"]);
(0,_functions_generateJokes__WEBPACK_IMPORTED_MODULE_3__["default"])(); // Call imported function `generateJokes` once
